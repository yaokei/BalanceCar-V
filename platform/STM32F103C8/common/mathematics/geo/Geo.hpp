...
#include "Geo_mag_declination.hpp"

#define M_ONE_G                         9.80665f    /* m/s^2 */
#define M_AIR_DENSITY_SEA_LEVEL_15C     1.225f      /* kg/m^3 */
#define M_AIR_GAS_CONST                 287.1f      /* J/(kg * K) */
#define M_ABSOLUTE_NULL_CELSIUS         -273.15f    /* °C */
#define M_RADIUS_OF_EARTH               6371000.0f  /* meters */
...
void get_vector_to_next_waypoint(double lat_now, double lon_now, double lat_next, double lon_next,
                                float *v_n, float *v_e);
